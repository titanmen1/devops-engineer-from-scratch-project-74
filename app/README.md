...
To run tests with Postgres, you need to edit _config/config.js_ and under the `test` key comment out the use of SQLite and uncomment the environment variables
...
Specify environment variables manually or prepare a _.env_ file with the command
...
Export environment variables to work with the database or prepare a _.env_ file with variables
